...
public class JedisTest {
	...
	public void testString() throws InterruptedException {
		...
		System.out.println("===========获取原值，更新为新值==========");// GETSET is an atomic set this value and return the old value
																// command.
	...
	public void testNumber() {
		...
		System.out.println("获取key2的值：" + jedis.get("key2"));
		System.out.println("key3的值：" + jedis.get("key3"));
		System.out.println("key3的值加1：" + jedis.incr("key3"));// 此处会发生异常：redis.clients.jedis.exceptions.JedisDataException: ERR
	...
	public void testSortedSet() {
		...
		System.out.println("移除zset中分值在1-4之间的元素的：" + jedis.zremrangeByRank("zset", 1, 4));
		System.out.println("zset中的所有元素：" + jedis.zrange("zset", 0, -1));
